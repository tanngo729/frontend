...
function ProductAdminView() {
  ...
  // Hàm xử lý các thao tác bảng (cập nhật trạng thái, xóa, batch delete, thay đổi vị trí, ...)
    ...
    <AdminLayout>
      <div className="product-admin-view">
        ...
        <CreateProductModal
          ...
          form={createForm}
          initialValues={{ position: getNextPosition(), imageUrl: '', status: 'active' }}
